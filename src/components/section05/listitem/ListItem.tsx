  ...
  return (
    <div className="w-1/2 max-[1000px]:w-full h-[25vw] max-[1000px]:h-[55vw] relative group overflow-hidden">
      ...
      >
        ...
        <div className="absolute text-white bottom-[5vw] max-[1000px]:bottom-[8vw] left-0 z-10 w-full flex flex-col justify-center items-center  opacity-0 group-hover:opacity-100 transition-all duration-[.5s] ease-out">
        ...
        <div className="text-white w-full h-full flex flex-col pt-[6vw] items-center absolute top-0 left-0 bg-opacity-0 group-hover:bg-opacity-100 group-hover:bg-[rgba(0,0,0,0.5)]">
